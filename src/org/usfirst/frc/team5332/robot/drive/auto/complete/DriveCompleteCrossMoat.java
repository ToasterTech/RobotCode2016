...
import org.usfirst.frc.team5332.robot.drive.auto.crossing.DriveCrossingMoat;
...
public class DriveCompleteCrossMoat extends DriveCommandLayer {
	...
	public void robotInit() {
		...
		queue.addAutoLayer(new DriveCrossingMoat());
